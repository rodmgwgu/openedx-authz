...
"""
openedx-authz documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-authz',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/openedx-authz",
...
#
# html_title = 'openedx-authz v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_authz'),
